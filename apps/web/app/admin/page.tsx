...
type WhatsAppApplication = { id: string; full_name: string; dni_masked?: string | null; phone_masked?: string | null; birth_date?: string; address?: string; email?: string | null; employment_status: string; employment_detail?: string | null; monthly_income: number; requested_amount: number; contact_1?: EmergencyContact; contact_2?: EmergencyContact; documents_received: number; cbu_masked?: string | null; holder_name?: string; state: string; created_at: string };
